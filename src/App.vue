...
:root {
  ...
  --color-background--layer-0: #161D31;
  --color-background--layer-10: #101422;
  --color-background--layer-20: #202738;
  --color-background--layer-0: #111827;
  --color-background--layer-10: #0C111B;
  --color-background--layer-20: #1F2937;
  --color-background--layer-30: #1F2937;
  --color-background--layer-40: #0C111B;
  ...
  --card-bg-gradiant-start: #0C111B;
  --card-bg-gradiant-end: #1F2937;
